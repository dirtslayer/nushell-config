...
print "config_local_nupm: [warn] April 2024 Learning about Nushell Modules and Package Manager"

# location of cloned nupm repo ~/git/nupm

# location of nupm home ~/.config/nupm

# nupm https://github.com/nushell/nupm/tree/29916fc/.
...
## the rest was from before might still use parts for xdg_open_local.nu
## and nu_git_manager_local.nu
